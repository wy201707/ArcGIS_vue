...
export default {
    ...
    methods: {
        ...
        async handleItemClick(val, type) {
            ...
            console.log('featuresResult.geometry', featuresResult.geometry);
            /*             let polyline = {
                type: 'polyline', // autocasts as new Polyline()  擦，本来是polygon
                paths: featuresResult.geometry.rings,
            }; */
            try {
                graphic = new Graphic({
            ...
            // xcenter = (featuresResult.geometry.extent.xmin + featuresResult.geometry.extent.xmax) / 2;
            // ycenter = (featuresResult.geometry.extent.ymin + featuresResult.geometry.extent.ymax) / 2;
